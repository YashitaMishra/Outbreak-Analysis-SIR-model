...
unvaccinated_data = data[(data['Date'] <= "2021-01-16") & (data['State/UnionTerritory'] == 'Kerala')] #Gives the data for 200 days of populations that didn't have access to vaccines in the state of Kerala.
# The same thing is done for the vaccinated populations. 
vaccinated = data[(data['Date'] >= "2021-01-16") &(data['State/UnionTerritory'] == 'Kerala')]
N_Kerala = 35500000 #initial population of Kerala in 2020 
print(f"Unvaccinated data size: {len(unvaccinated_data)} days")
print(f"Vaccinated data size: {len(vaccinated)} days")
